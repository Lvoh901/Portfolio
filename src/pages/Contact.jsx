...
const Contact = () => {
  return (
    <div className=''>
      <section className='min-h-screen mx-auto max-w-7xl flex flex-col justify-center items-center' id='heading'>
        <div className='font-black uppercase text-4xl md:text-5xl lg:text-6xl pb-2 animate-fade-up'>get in touch</div>
        ...
        <p className='pt-7 underline underline-offset-4 decoration-[#fcba04] uppercase font-black'>Reach out directly:</p>
        <h4 className='flex items-center gap-1.5 font-light'><MdOutlineAlternateEmail />: info@odhiambolvis.tech</h4>
        <h4 className='flex items-center gap-1.5 font-light uppercase'><MdOutlineLocalPhone/>: (254) 718-505-642 (mon - fri: 8am - 5pm eat)</h4>
