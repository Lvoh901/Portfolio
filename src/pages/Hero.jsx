      ...
      <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto gap-4">
        ...
        >
          ...
          <motion.h1
            ...
            transition={{ delay: 0.7 }}
            id='heading'>
            <span className='italic underline underline-offset-4 decoration-[#fcba04]'>Building</span> Exceptional User Experiences & Brands
          </motion.h1>

          <button className='bg-black py-1.5 px-3 text-gray-300 hover:text-white hover:font-bold rounded-full cursor-pointer'>Let's Connect</button>
